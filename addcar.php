...
if (mysqli_error($con))
{
   die(mysqli_error($con));
    ...
    <div style="width:50%; font-size:30px; float:left; margin-left:0px;">
        <div style="width:70%; border-radius:10px; background-color:#c3c3c3; margin-left:100px; border-top:10px solid black;">
        <center>
    <h1>Rent a Car</h1>
    <form method = "post" action = "addcar2.php">
    <input type="text"  placeholder="Car Name" id="carname" name="name" style="width:40%; height:50px; border:1px solid black;  font-size:20px; border-radius:10px; padding:0px 0px 0px 10px;"/><br/><br/>
    
    <input type="text"  placeholder="Car Model" id="carmodel" name="model" style="width:40%; height:50px; border:1px solid black;  font-size:20px; border-radius:10px; padding:0px 0px 0px 10px;"/><br/><br/>
    
   <input type="number"  placeholder="Car Price" id="carprice" name="price" style="width:40%; height:50px; border:1px solid black;  font-size:20px; border-radius:10px; padding:0px 0px 0px 10px;"/><br/><br/>
